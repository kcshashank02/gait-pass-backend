...
#     db=Depends(get_database)
# ):
#     """Create or update fare between stations (admin only)"""
#     try:
#         station_model = Station(db)
...
#         return {
#             "success": True,
#             "message": "Fare created/updated successfully",  # ✅ Updated message
#             "fare": fare
#         }
...
#     skip: int = 0,
#     limit: int = 100,
#     current_user: dict = Depends(get_current_user),  # Both users and admins
#     db=Depends(get_database)
# ):
#     """Get all fares - accessible by all authenticated users"""
#     try:
