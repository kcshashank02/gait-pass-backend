...
# # ):
# #     """
# #     Create a new admin user (MongoDB). Only accessible by existing admins.
# #     """
# #     try:
# #         user_model = User(db)
...
# #         admin_data = {
# #             "email": user_data.email,
# #             "password": user_data.password,  # Will be hashed by User model
# #             "first_name": user_data.first_name,
# #             "last_name": user_data.last_name,
# #             "phone": user_data.phone,
# #             "date_of_birth": user_data.date_of_birth,
...
# #     db = Depends(get_database)
# # ):
# #     logger.info(f"Creating admin user: {user_data.email}")
# #     logger.info(f"Requested by admin: {admin_user.get('email')}")
...
# #         created_user = await user_model.create_admin_user(admin_data)
# #         logger.info(f"Admin user created successfully: {created_user.get('email')}")

# #         # Use existing method to create admin user
# #         created_user = await user_model.create_admin_user(admin_data)
...
#         # Let the User model handle all validation
...
#         # This will raise ValueError if duplicate exists
#         created_user = await user_model.create_admin_user(admin_data)
        
#         # Only reach here if creation succeeded
#         created_user["id"] = str(created_user.pop("_id"))
...
#     except ValueError as e:
#         # Catch ValueError from User model (duplicate email/phone)
